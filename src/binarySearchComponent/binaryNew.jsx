...
//////////////////////////////////////////////////
export default class BinaryNew extends Component {
    state = {
        arr: []
    }
    constructor () {
    ...
    return (
        <div>
            <p class="header">Binary Search</p>
                ...
                <div id="array" style={{display: "flex", alignItems: "end" }}>
            {this.state.arr.map(a => <div style={{
                height:a,
                background: "black",
                margin: 2
            }}>{a}</div>)}
                ...
                <br /><br />
                <button id="btn"
                        onclick={() => console.log('binarySearch')}>Search</button>
                <br />
                <br />
                <div id="text"></div>
                </div>
